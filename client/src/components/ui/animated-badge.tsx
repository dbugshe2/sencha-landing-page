...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative flex max-w-fit items-center justify-center gap-2 rounded-full glass-card px-4 py-1.5 text-neutral-700 transition-colors dark:border-neutral-700/80 dark:glass-subtle dark:text-zinc-300"
    >
      <div
