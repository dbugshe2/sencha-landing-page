 ...
 * @returns An object containing the toast ID and control functions (dismiss, update).
 */
...
/**
 * Hook to access and manage toast notifications in components.
 * Returns the current list of toasts and the `toast` function to trigger new ones.
 * @returns An object containing the toast state and control functions.
 */
function useToast() {
