...
function Navbar() {
  ...
  return (
    <motion.nav
      className={`fixed left-1/2 w-full transform -translate-x-1/2 z-50 transition-all duration-500 ${
        isScrolled
          ? "top-8 bg-secondary/70 backdrop-blur-xl border border-secondary rounded-full shadow-lg px-8 py-3 max-w-4xl mx-auto"
          : " bg-secondary px-6 py-4 w-full max-w-full"
      }`}
    >
        ...
        <div className="flex items-center space-x-8 justify-between">
          <a href="/#0" className="shrink-0">
            <img
              ...
              className={isScrolled ? "w-24 h-12 " : "w-32 h-16"}
              alt="Sencha"
            />
          </a>
